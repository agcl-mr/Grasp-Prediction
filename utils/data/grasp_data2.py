...
#changing  __getitem__(self, idx): output 
# original== return x, (pos, cos, sin, width), idx, rot, zoom_factor
# changed== return x, (pos, cos, sin, width,x.clamp(0, 1)), idx, rot, zoom_factor
class GraspDatasetBase(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return x, (pos, cos, sin, width,x), idx, rot, zoom_factor
